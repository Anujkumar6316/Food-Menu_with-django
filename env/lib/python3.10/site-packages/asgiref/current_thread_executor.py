...
class CurrentThreadExecutor(Executor):
    ...
    def submit(self, fn, *args, **kwargs) -> Future[_R]:
    ...
    def shutdown(self, wait: bool = True) -> None:
        """
        Stops the executor from accepting new tasks and waits for all the tasks to be completed.
        """
        self._broken = True
        if wait:
...
if __name__ == "__main__":
    with CurrentThreadExecutor() as executor:
